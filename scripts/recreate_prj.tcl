...
#
# recreate_prj.tcl: Tcl script for re-creating project 'adapter_board'
#
# Generated by Vivado on Fri Jun 21 14:41:44 CEST 2019
...
#    "sdk/motors/Debug/motors.elf"
#    "sdk/imus/Debug/imus.elf"
#    "sdk/bu/Debug/bu.elf"
#    "xdc/constraints.xdc"
#
#*****************************************************************************************
...
set _xil_proj_name_ "adapter_board"
...
set files [list \
 ...
 [file normalize "${origin_dir}/../sdk/motors/Debug/motors.elf"] \
 [file normalize "${origin_dir}/../sdk/bu/Debug/bu.elf"] \
 [file normalize "${origin_dir}/../sdk/imus/Debug/imus.elf"] \
]
...
set file "$origin_dir/../sdk/motors/Debug/motors.elf"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "scoped_to_cells" -value "Motors/microblaze_0" -objects $file_obj
...
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "scoped_to_cells" -value "BU/microblaze_2" -objects $file_obj
set_property -name "scoped_to_ref" -value "design_1" -objects $file_obj
set_property -name "used_in" -value "implementation" -objects $file_obj
set_property -name "used_in_simulation" -value "0" -objects $file_obj
