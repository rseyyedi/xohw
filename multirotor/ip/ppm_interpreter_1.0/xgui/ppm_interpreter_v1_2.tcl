...
proc init_gui { IPINST } {
  ...
  set_property tooltip {minimum Time for synchronization for PPM Signal} ${syncTime}
  set timeoutTime  [  ipgui::add_param $IPINST -name "timeoutTime" -parent ${Page_0} -display_name {timeoutTime}]
  set_property tooltip {minimum time until timeout appear. Must be bigger then the sending time of one signal} ${timeoutTime}
