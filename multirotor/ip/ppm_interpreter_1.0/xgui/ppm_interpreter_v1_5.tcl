...
proc init_gui { IPINST } {
  ...
  set_property tooltip {minimum time until timeout appear. Must be bigger then the sending time of one signal. realTime= timeoutTime *10ns => 2100000ns = 2,1ms => when this time after transmission is reached the transmission is done.} ${timeoutTime}
